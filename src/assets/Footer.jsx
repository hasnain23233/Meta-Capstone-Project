                    ...
                    <div className="border-b border-gray-100 py-6 dark:border-gray-700 md:py-8 lg:py-16">
                        <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
                            <div className="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
                                ...
                                <div>
                                    <h6 className="mb-4 text-sm font-semibold uppercase text-gray-900 dark:text-white">Rewards</h6>
                                    <ul className="space-y-3">
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Reward Points</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Referral Program</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">VIP Membership</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Exclusive Offers</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Redeem Rewards</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">What is Trade Assurance?</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">How It Works</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Buyer Protection</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Seller Guarantee</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">FAQs</a>
                                        </li>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Seller Registration</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">How to Sell</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Seller Policies</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Seller Resources</a>
                                        </li>
                                        <li>
                                            <a href="#" title="" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Seller Support</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="py-6 md:py-8">
                        <div className="gap-4 space-y-5 xl:flex xl:items-center xl:justify-between xl:space-y-0">
                            ...
                            <ul className="flex flex-wrap items-center gap-4 text-sm text-gray-900 dark:text-white xl:justify-center">
                                ...
                                <li><a href="#" title="" className="font-medium hover:underline"> Legal Notice </a></li>
                                <li><a href="#" title="" className="font-medium hover:underline"> Product Listing Policy </a></li>
                                <li><a href="#" title="" className="font-medium hover:underline"> Terms of Use </a></li>
                            </ul>

                            <p className="text-sm text-gray-500 dark:text-gray-400">© 2024 <a href="#" className="hover:underline">Hasnain khushi</a>, Inc. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
